...
export class CrudService {
  ...
  admUrl="http://localhost:8083/organisation/organisations";
  loginUrl="http://localhost:8083/admin/login";
  private baseUrl = 'http://localhost:8083/demandeBus';
  private baseUrl2 = 'http://localhost:8083/demandeMateriel';
  private baseUrl3 = 'http://localhost:8083/demandeSalle';
  private Url = 'http://localhost:8083/';
  private propUrl = 'http://localhost:8083/proposition';
  private reclUrl = 'http://localhost:8083/reclamation';
  ...
  loginAdmin(admin: Admin){
    return this.http.post<any>(this.loginUrl, admin,{withCredentials:false});
  }
  isLoggedIn(){
  ...
  confirmOrganisation(id: number): Observable<any> {
    ...
    return this.http.post(url, null,{withCredentials:false});
  }
  ...
  ajoutorganisation(organisation: Organisation): Observable<any> {
    return this.http.post(`${this.apiUrl}/organisation/creer`, organisation,{withCredentials:false});
  }
  ...
  login(formData: String){
    return this.http.get(this.apiUrl + '/organisation/login/' + formData);
  }

  registerOrganisation(organisation: Organisation): Observable<any> {
    return this.http.post(`${this.Url}organisations/registerorganisation`, organisation,{withCredentials:false});
  }
  ...
  ajoutdemandeBus(demandeBusDto: any): Observable<any> {
    return this.http.post(`${this.baseUrl}`, demandeBusDto,{withCredentials:false});
  }
  ...
  ajoutdemandeMateriel(demandeMaterielDto: any): Observable<any> {
    return this.http.post(`${this.baseUrl2}`, demandeMaterielDto,{withCredentials:false});
  }
  ...
  ajoutdemandeSalle(demandeSalleDto: any): Observable<any> {
    return this.http.post(this.apiUrl + "/demandeSalle/ajouter", demandeSalleDto,{withCredentials:false});
  }
...
//-------------------------------------------RECLAMATIONS------------------------------------------------------------
  ajouterReclamation(reclamation: Reclamation): Observable<Reclamation> {
    return this.http.post<Reclamation>(`${this.reclUrl}`, reclamation,{withCredentials:false});
  }
  ...
  ajouterProposition(proposition: Proposition): Observable<Proposition> {
    return this.http.post<Proposition>(`${this.propUrl}`, proposition,{withCredentials:false});
  }
